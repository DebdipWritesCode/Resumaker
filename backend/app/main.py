...
from app.routers import auth, ai, admin, compile as compile_router, heading, education, experience, project, skill, certification, award, volunteer, custom_resume, payment, dashboard
