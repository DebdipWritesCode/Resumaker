// Full list of country calling codes sorted alphabetically by country name
...
export const getFlagEmoji = (iso: string): string => {
  // Convert ISO code to regional indicator symbols for flag emoji
